        ...
        <fieldset>
            ...
            <fieldset>
                <div>
                    ...
                    <input type="text" name="txtdata" id="txtdata" alt="date" class="texto02" value="<? if(@$solicitacao[0]->data_prevista != ''){echo date("d/m/Y",strtotime(@$solicitacao[0]->data_prevista));}?>" required/>
                </div>
                <div>
                    <label>Hora</label>
