                    ...
                    <tbody>
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="30px;"><div class="bt_link">
                                        <a href="<?= base_url() ?>centrocirurgico/centrocirurgico/importarquivos/<?= $item->solicitacao_cirurgia_id; ?>">Excluir</a></div>
                                </td> 
                                <? if ($item->orcamento_completo == 'f' && $item->orcamento == 't') { ?>
