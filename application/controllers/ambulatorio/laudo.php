...
//        $config['upload_path'] = "/home/vivi/projetos/clinica/upload/consulta/" . $paciente_id . "/";
    ...
    function gravarreceituario($internacao_id, $paciente_id, $procedimento_tuss_id) {

        $this->laudo->gravarreceituario($internacao_id);
        $data['ambulatorio_laudo_id'] = $ambulatorio_laudo_id;
        $data['paciente_id'] = $paciente_id;
        $data['procedimento_tuss_id'] = $procedimento_tuss_id;

        $this->session->set_flashdata('message', $data['mensagem']);
        redirect(base_url() . "ambulatorio/laudo/carregarreceituario/$internacao_id/$paciente_id/$procedimento_tuss_id");
    }
